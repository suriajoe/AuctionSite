...
<body>
		<%
			...
			LinkedList<PCItem> ps = dao.getAllPC();
			...
			for(int i=0; i<auc.size(); i++){
				for(int j=0; j<ps.size(); j++){
					if(auc.get(i).getAuctionId() == ID && ps.get(j).getId() == auc.get(i).getItemId()){
						...
						<p style='text-align:center; font-family:Sans-serif; font-size:20px;'>CPU Minimum: <%= ps.get(j).getCPU() %></p>
						<p style='text-align:center; font-family:Sans-serif; font-size:20px;'>RAM Minimum: <%= ps.get(j).getRAM() %></p>
						<p style='text-align:center; font-family:Sans-serif; font-size:20px;'>HDD Space Requirement: <%= ps.get(j).getHDD() %></p>
						<p style='text-align:center; font-family:Sans-serif; font-size:20px;'>Graphics Requirement: <%= ps.get(j).getGfx() %></p>
