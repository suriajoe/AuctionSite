...
<body>
	<h1 style="text-align:center; font-family:sans-serif;">Playstation Games On Auction:</h1>
	<%
		...
		LinkedList<ConsItem> psResult = dao.getPlaystationSearchResult(title, version, cond);
